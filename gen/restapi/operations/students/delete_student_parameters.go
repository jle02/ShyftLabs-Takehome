...
// DeleteStudentParams contains all the bound params for the delete student operation
...
func (o *DeleteStudentParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
